...
module.exports = async (data, utils) => {
    ...
    addUIDependency(data, '@genesislcap/pbc-{{appName}}-ui', versions.dependencies.pbcClientVersion);

    addServerDependency(data, {name: '{{appName}}'}, versions.dependencies.pbcServerVersion);
};
